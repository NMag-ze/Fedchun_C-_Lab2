...
namespace lab2
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           Console.WriteLine("Предыдущая дата - {0}.{1}.{2}", predd, predm, predy);
           Console.WriteLine("Cледующая дата - {0}.{1}.{2}", nexeld, nexelm, nexely); 
           */
            //2.3
            /*int k(int a)
            {
            ...
            for (int i = 100; i < 1000; i++)
            {
                ...
                second = (i / 10) % 10;
                third = (i / 100) % 10;
                arms = k(first) + k(second) + k(third);
                if (arms == i) Console.WriteLine("{0} - трехзначное число Армстронга", i);
            } 
            */
            //2.4
            ...
            */
            ...
            double a;
            a = Math.Pow(v, 1.0/3);
            Console.WriteLine("Ребро куба равно = {0:F3}", a); 
            */
            //3.2
            /*int i = 43;
            if (((i % 10) + ((i / 10) % 10)) % 2 == 1) Console.WriteLine("Нечет");
            else Console.WriteLine("Чет"); 
            */
            //3.3
            /*Console.Write("x =");
            ...
            if(x <= 10 && y <= 5 && x > 0 && y > 0) Console.WriteLine("Внутри");
